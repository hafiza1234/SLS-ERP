...
time.sleep(2)
browser.find_element_by_xpath("//input[@id='style_name']").send_keys("new_kurti 1")
time.sleep(2)
browser.find_element_by_xpath("//input[contains(@id,'style_desc')]").send_keys("good")
time.sleep(2)
browser.find_element_by_xpath("//input[@id='offer_qty']").send_keys("500")
time.sleep(3)
a3 = Select(browser.find_element_by_id("season_id"))
a3.select_by_index(1)
time.sleep(5)
browser.find_element_by_xpath("//input[@id='season_grp']").send_keys("Large")
a16 = Select(browser.find_element_by_name("style_uom"))
a16.select_by_index(1)
time.sleep(2)
...
a6.select_by_index(2)
time.sleep(2)
a7 = Select(browser.find_element_by_id("fabric_composition_id"))
a7.select_by_index(4)
time.sleep(2)
browser.find_element_by_xpath("//input[contains(@id,'code')]").send_keys("22345545")
time.sleep(2)
...
time.sleep(2)
a10 = Select(browser.find_element_by_id("uom"))
a10.select_by_index(1)
time.sleep(4)
...
time.sleep(5)
a20 = Select(browser.find_element_by_xpath("//select[@id='uom']"))
a20.select_by_index(2)
time.sleep(5)
browser.find_element_by_xpath("(//button[@type='button'])[3]").click()
time.sleep(5)
