...
time.sleep(2)
browser.find_element_by_xpath("(//span[contains(.,'Section')])[1]").click()
time.sleep(2)
browser.find_element_by_xpath("//input[@id='name']").send_keys("Knitting")
time.sleep(2)
browser.find_element_by_xpath("//input[@id='description']").send_keys("stable")
time.sleep(2)
